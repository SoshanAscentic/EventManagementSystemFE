...
function AlertDialogAction({
  ...
  return (
    <AlertDialogPrimitive.Action
      className={cn(buttonVariants(), "data-[variant=destructive]:bg-red-600 data-[variant=destructive]:text-white data-[variant=destructive]:hover:bg-red-700", className)}
      {...props}
    />
  )
}
